...
import net.openchrom.msd.converter.supplier.muf.converter.io.MufReader;

public class DatabaseImportConverter extends AbstractDatabaseImportConverter {

	private static final String DESCRIPTION = "MicrobeMS Spectral Multifiles .muf Import";
	...
	public IProcessingInfo<IMassSpectra> convert(final File file, final IProgressMonitor monitor) {
		...
		if(!processingInfo.hasErrorMessages()) {
			try {
				final MufReader peaksReader = new MufReader();
